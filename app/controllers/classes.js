...
{
	var item = results[c];
	var row = Ti.UI.createTableViewRow({height:'150', layout:'horizontal',id:item.classID, hasChild:true});
	row.addEventListener('click', openClassDetail);
		
	var imagePhoto = Ti.UI.createImageView({image:item.classImageURL, width:'100px', left:'10'});
	row.add(imagePhoto);
