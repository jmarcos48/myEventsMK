function Controller() {
    ...
    $.__views.classDetailWindow.add($.__views.title);
    $.__views.speaker1 = Ti.UI.createView({
        backgroundColor: "white",
        width: "85%",
        borderColor: "black",
        borderRadius: "6",
    ...
    $.__views.classDetailWindow.add($.__views.speaker1);
    $.__views.speakerPhoto = Ti.UI.createImageView({
        id: "speakerPhoto",
        width: "100px",
        left: "10",
        top: "0"
    });
    $.__views.speaker1.add($.__views.speakerPhoto);
    ...
    $.__views.speaker1.add($.__views.rowContainer);
    ...
    $.__views.rowContainer.add($.__views.speakerName);
    $.__views.speakerTitle = Ti.UI.createLabel({
        font: {
            fontSize: 11
        },
        color: "gray",
    ...
    $.__views.rowContainer.add($.__views.speakerTitle);
